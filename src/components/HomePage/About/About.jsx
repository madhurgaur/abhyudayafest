...
import './about.css'
import ribbonBanner from '../../../Assets/A (1).png'
// import garland from '../../../Assets/flag-garland-balloon-clipart-xl.png'
import aero from '../../../Assets/paper-plane-clipart-xl.png'
const About = () => {
  return (
    <>
    <div className='fest__about'>
      ...
      <div className='ribbon'>
             <img src={ribbonBanner} alt='ribbon'/>
           </div>
